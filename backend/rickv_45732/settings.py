"""
Django settings for rickv_45732 project.
...
WSGI_APPLICATION = 'rickv_45732.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rickv_45732 API",
    "DESCRIPTION": "API documentation for rickv_45732 App",
    "VERSION": "v1",
}
